...
nm/$(OBJECT_DIR)/add_to_obuff.o: nm/add_to_obuff.c nm/nm.h \
  ...
  common/opt/opt.h libft/output/obuff.h libft/math/math.h \
...
nm/$(OBJECT_DIR)/display_symbols.o: nm/display_symbols.c nm/nm.h \
  common/data_structures.h common/typedefs.h libft/memory/memory.h \
  common/opt/opt.h libft/output/obuff.h common/common.h
common/common.h:
nm/$(OBJECT_DIR)/get_symbols.o: nm/get_symbols.c nm/nm.h \
  common/data_structures.h common/typedefs.h libft/memory/memory.h \
  common/opt/opt.h libft/output/obuff.h common/common.h
nm/$(OBJECT_DIR)/nm.o: nm/nm.c nm/nm.h common/data_structures.h \
  common/typedefs.h libft/memory/memory.h common/opt/opt.h \
  libft/output/obuff.h common/common.h libft/output/output.h
libft/output/output.h:
nm/$(OBJECT_DIR)/nm_options.o: nm/nm_options.c nm/nm.h \
  common/data_structures.h common/typedefs.h libft/memory/memory.h \
  common/opt/opt.h libft/output/obuff.h libft/string/string.h \
  libft/output/output.h
